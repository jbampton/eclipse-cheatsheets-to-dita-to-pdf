<?xml version="1.0" encoding="utf-8"?><!-- This file is part of the DITA Open Toolkit project.
  ...
  <xsl:import href="xslodt/markup-d.xsl"></xsl:import>
  <xsl:import href="xslodt/xml-d.xsl"></xsl:import>
  <!--
  ...
  <xsl:param name="YEAR" select="format-date(current-date(), &apos;[Y]&apos;)"></xsl:param>
